...
Original file is located at
    https://colab.research.google.com/drive/12fvPejyu4V7PuGDoInzgKR5HblyY2vYS
"""
...
# # Simpan aplikasi streamlit ke apps.py
# %%writefile apps.py
...
# Ganti 'YOUR_AUTH_TOKEN' dengan token otentikasi ngrok Anda yang sebenarnya
# Anda bisa mendapatkannya dari https://dashboard.ngrok.com/get-started/your-authtoken
ngrok.set_auth_token('3DHrmguUJ6A5gjZLaH9Yi8mWKjd_5c5X3WQCQEVqGebZ7PDwK')
